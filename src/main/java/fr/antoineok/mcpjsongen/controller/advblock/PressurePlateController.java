...
import fr.antoineok.mcpjsongen.generation.advblock.GenerateBlockPressurePlate;
...
public class PressurePlateController {
    ...
    @FXML private void handleGenerateButtonAction(ActionEvent event) {
        GenerateBlockPressurePlate.genBlock(fieldBlockName.getText(), fieldTextureName.getText(), fieldExportPath.getText());
